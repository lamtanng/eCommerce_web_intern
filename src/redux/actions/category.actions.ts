...
const fetchCategory: AsyncThunk<
  AxiosResponse<CategoryProps, any>,
  CategoryParams,
  {}
> = createAsyncThunk('category/fetchCategory', async (data: CategoryParams) => {
...
const createCategory = createAsyncThunk(
  ...
  async (data: CategorySchemaProps) => {
