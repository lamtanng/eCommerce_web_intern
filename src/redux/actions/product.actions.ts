...
import { GetAllProductParams, ProductFormSchemaProps, ProductProps } from '../../types/product.type';
...
const createProduct = createAsyncThunk('product/createProduct', async (data: ProductFormSchemaProps) => {
...
const updateProduct = createAsyncThunk('product/updateProduct', async (data: ProductFormSchemaProps) => {
