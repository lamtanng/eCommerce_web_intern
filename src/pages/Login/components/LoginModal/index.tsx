...
export default function LoginModal() {
  return (
    <>
      <Stack direction="column" spacing={4} alignItems="center" sx={{ paddingX: 3 }}>
        <Stack direction="column" spacing={2} alignItems="center">
          <img width="50px" src={Logo} />
          <Typography variant="h4" sx={{ fontWeight: '700', textTransform: 'uppercase' }}>
            Welcome!
          </Typography>
          <Typography variant="body2" sx={{ fontWeight: '400', color: 'GrayText', textAlign: 'center' }}>
        ...
        <Divider orientation="horizontal" variant="middle" flexItem sx={{ color: 'GrayText' }}>
          Or
        </Divider>
        <LoginForm />
        <Typography variant="body1" color="ButtonText" sx={{ marginTop: '24px' }}>
          Don't have account?{' '}
